...
public class MiddlewareController {
    ...
    final static Logger logger =  LoggerFactory.getLogger(MiddlewareController.class);

    @PostMapping("/test")
    public BusquedaCuentaResponse testMiddleware(@Valid @RequestBody BusquedaCuentaRequest busquedaCuentaRequest) {
